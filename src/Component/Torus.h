...
class Torus: public Surface {
  ...
  public:
	...
	Torus(Position&& position):Surface(position,TorusMap(DEFAULT_R1,DEFAULT_R2),GL_LINES){}
	Torus(Position&& position,float r1,float r2):Surface(position,TorusMap(r1,r2),GL_LINES){}
