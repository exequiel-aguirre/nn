...
class MyContainer:public Container{
  public:
    MyContainer(Position&& position):Container(position){
			...
			Sphere* mySphere3=new Sphere(Position(3.0f,8.0f,-20.0f),2.0f);
			Sphere* mySphere4=new Sphere(Position(-20.0f,20.0f,-20.0f),0.5f);
			...
			add(new Plane(Position(15.0f,8.0f,-20.0f,0.0f,0.0f,90.0f),5.0f,5.0f,"img/box.bmp",2,2));
			add(new Plane(Position(-20.0f,10.0f,-20.0f,45.0f,0.0f,0.0f),5.0f,20.0f,"img/box.bmp",2,2));
