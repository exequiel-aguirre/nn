  ...
  public:
    ...
    static bool detect(Component* c1,Component* c2){
        ...
        if( (min1->x <= max2->x) && (max1->x >= min2->x) &&
            ...
            if((abs(max1->x-min2->x)<epsilon) || (abs(min1->x-max2->x)<epsilon)){                                
            ...
            //collision on Y
            if((abs(max1->y-min2->y)<epsilon) || (abs(min1->y-max2->y)<epsilon)){
            ...
            //collision on Z
            if((abs(max1->z-min2->z)<epsilon) || (abs(min1->z-max2->z)<epsilon)){            
